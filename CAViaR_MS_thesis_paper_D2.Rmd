...
Many of the approaches for modeling VaR rely on a semiparametric or a nonparametric historical simulation [@Richardson2005]. A popular approach to modeling VaR called RiskMetrics was introduced by J.P. Morgan in 1994 and upgraded in 1996 [???]
...
Following Engle and Manganelli's 2004 paper, we choose $G = 10$, so that is what is used in the results section of this paper. Sensitivity analysis shows that the choice of the G parameter does not widely vary the forecast's accuracy.
