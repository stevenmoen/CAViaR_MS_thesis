...
The authors describe the parameter $G$ as "some positive number", but in the Empirical Results section of their paper, they use $G = 10$, so that's what is used in the results section of this paper.
...
$$
\overset{\min}\beta \frac{1}{T}\sum_{t=1}^T [\theta - I(y_t < f_t(\boldsymbol{\beta}))][y_t - f_t(\boldsymbol{\beta})]
$$
